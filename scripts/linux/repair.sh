...
apply_wmpf_patches() {
  ...
  local network_debug_patcher="$LONGMAO_INSTALL_ROOT_RESOLVED/patches/wmpf-debugger/apply-network-debug-adapter.mjs"
  ...
  [[ -f "$network_debug_patcher" ]] || die "WMPFDebugger Network Debug 补丁器缺失: $network_debug_patcher"
